...
public class AuthorizacionPageObject extends MainPageObject {
    ...
    public AuthorizacionPageObject(RemoteWebDriver driver){
        super(driver);
    }

    public void clickAuthButton() throws Exception{
        this.waitForElementPresent(LOGIN_BUTTON,"Cannont find auth button",5);
